...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleDatabaseException(DataIntegrityViolationException e) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(new ApiResponse("DB_ERROR", "데이터 처리 중 오류가 발생했습니다.", null));
    }
    ...
    public ResponseEntity<ApiResponse> handleValidationException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.badRequest().body(new ApiResponse("VF", message, null));
    }
    ...
    public ResponseEntity<ApiResponse> handleJwtException(Exception e) {
        ...
        return ResponseEntity
                ...
                .body(new ApiResponse("IVT001", "로그인 정보가 만료되었습니다. 다시 로그인해 주세요.", null));
    }
    ...
    public ResponseEntity<ApiResponse> handleUserException(MemberException e) {
        log.error("User 에러: ", e);
